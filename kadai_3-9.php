...
<html lang="ja">
    ...
    <body>
        ...
        <div align="center">
            ...
            <br>
            <a href="http://データベース名/kadai_3-7.php">登録済みの方はこちら</a>
        </div>
    </body>
</html>
    ...
    <?php
        ...
        function Sendconfmail($uid){
            ...
            $title = "掲示板登録の認証メールです";
            $to = $_POST['mail'];
            $content = "ログインする場合はこのURLからログインしてください。http://データベース名/kadai_3-7.php?uid=".$uid;
            if(mb_send_mail($to, $title, $content)){
                echo "メールを送信しました。認証するまでログインすることはできません。";
            } else {
                echo "メールの送信に失敗しました";
            }
        }
